...
export async function updateArrayBoundary(arrayDiagram, duration) {
    ...
    const updateBoundaryPromise =  arrayDiagram.arrayBoundary
    .transition()
    .duration(duration/2)
    .style("opacity", 1.0)
    .attr("width", (arrayDiagram.properties.ITEM_SIZE + arrayDiagram.properties.PADDING) * arrayDiagram.data.length + arrayDiagram.properties.PADDING)
    .end();
