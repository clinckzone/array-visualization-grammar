...
export async function addArrayElement(
	...
	transPromises.push(
		_elemEnter
			...
			.style('opacity', 1.0)
			.attr('width', arrayDiagram.properties.itemSize)
			.attr('height', arrayDiagram.properties.itemSize)
			.attr('x', -arrayDiagram.properties.itemSize / 2)
			.attr('y', -arrayDiagram.properties.itemSize / 2)
			.attr('rx', arrayDiagram.properties.itemSize / 6)
			.transition()
			.duration(duration / 2)
